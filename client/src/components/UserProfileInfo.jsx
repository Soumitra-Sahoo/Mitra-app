...
const UserProfileInfo = ({ user, posts, profileId, setShowEdit }) => {
  return (
    <div className=' relative py-3 px-6 md:px-8 bg-white'>
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    { !profileId && 
                        <button onClick={()=>setShowEdit(true)} className='flex items-center gap-2 border cursor-pointer border-gray-300 hover:bg-gray-50 px-4 py-2 font-medium transition-colors mt-4 md:mt-0 rounded-2xl'>
                            <PenBox className='size-4'/>
                            Edit
                        </button>
                    }
                </div>
                <p className='text-gray-700 text-sm max-w-xl mt-2 leading-relaxed'>{user.bio}</p>
                ...
                <div className='flex items-center gap-8 mt-4 border-t border-gray-200 pt-3'>
                    <div>
