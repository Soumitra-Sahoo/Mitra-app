...
const StoryModel = ({setShowModel, fetchStories}) => {
    const bgColors = ["#00B5FF","#7c3aed","#46e671ff","#e11d48","#f4b733ff","#0d9488","#4de5e7ff","#a3ff"]
  ...
  return (
    ...
    text-white flex items-center justify-center justify-center p-4'>
      <div className='w-full max-w-md'>
        ...
        <div className='flex gap-2 mt-4'>
            ...
            setPreviewUrl(null)}} className={`flex-1 flex items-center justify-center gap-2 p-2 rounded cursor-pointer
        ...
        rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700
