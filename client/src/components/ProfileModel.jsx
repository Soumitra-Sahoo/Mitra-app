        ...
        <div className="bg-card rounded-lg shadow p-6">
          ...
          >
            ...
            <div className="flex flex-col items-start gap-3">
              <label htmlFor="profile_picture" className="block text-sm font-medium text-foreground-secondary mb-1">
                Profile Picture
                <input
                  hidden
                  type="file"
                  accept="image/*"
                  id="profile_picture"
                  className="w-full p-3 border border-border bg-card text-foreground rounded-lg"
                  onChange={(e) =>
            ...
            {/* Cover Photo */}
            <div className="flex flex-col items-start gap-3">
              <label htmlFor="cover_photo" className="block text-sm font-medium text-foreground-secondary mb-1">
                Cover Photo
                <input
                  hidden
                  type="file"
                ...
                <div className="group/cover relative">
                  <img
                    ...
                    className="w-80 h-40 rounded-lg bg-gradient-to-r from-gradient-start to-gradient-end object-cover mt-2"
                    alt=""
                  />
            ...
            <div>
              <label className="block text-sm font-medium text-foreground-secondary mb-1">Bio</label>
              <textarea
                rows={3}
                className="w-full p-3 border border-border bg-card text-foreground rounded-lg"
            ...
            <div className="flex justify-end space-x-3 pt-6">
              <button
                ...
                className="px-4 py-2 border border-border rounded-lg hover:bg-surface text-foreground-secondary transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-4 py-2 bg-gradient-to-r from-gradient-start to-gradient-end text-white rounded-lg hover:brightness-110 transition cursor-pointer"
              >
                Save Changes
              </button>
            </div>
